  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('Manage Table')); ?></h5>
      ...
      <div class="modal-body">
        <div class="form-group">
          <label for="exampleFormControlInput1"><?php echo e(__('Table name')); ?></label>
          <input type="text" class="form-control" id="table_name" name="table_name" placeholder="<?php echo e(__('Table name')); ?>">
        </div>
        <div class="form-group">
          <label for="exampleFormControlInput1"><?php echo e(__('Table size')); ?></label>
        ...
        <div class="custom-control custom-checkbox">
          ...
          <label class="custom-control-label" for="table_round"><?php echo e(__('Round table')); ?></label>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo e(__('Close')); ?></button>
        <button type="button" data-dismiss="modal" onclick="javascript:saveTable()"  class="btn btn-success"><span class="text-white"><?php echo e(__('Save')); ?></span></button>
      </div>
    </div>
  </div>
</div>
                ...
                <div class="card bg-secondary shadow">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                              ...
                              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tableModal">
                                <i class="ni ni-fat-add"></i></span> <?php echo e(__('Add new table')); ?>

                              </button>
                              
                                <a href="javascript:saveFloor()" class="btn  btn-success" data-dismiss="modal"><span class="btn-inner--icon"><i class="ni ni-check-bold"></i></span> <?php echo e(__('Save')); ?></a>
                    ...
                    <div class="card-body" style="display: inline-block; text-align: center; justify-content: center; align-items: center; background-color:#f4f5f7">
                        <div class="canva" id="canvaHolder">
                            <?php $__currentLoopData = $restoarea->tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
...
<script>
  var area_id="<?php echo e($restoarea->id); ?>";
  var table_id=null;
  var edit_id=null;
  ...
  function saveFloor(){
    ...
    $.ajax({
        type:'post',
        data: {"items":items},
        url: "<?php echo e(route('floorplan.save',$restoarea->id)); ?>",
        success:function(response){
            if(response.status){
              alert("<?php echo e(__('Floor plan is saved.')); ?>");
            }else{
              alert(response.message);
            }
        }, error: function (response) {
          alert("<?php echo e(__('Error on save')); ?>");
        }
    })
...
<script type="module">
    ...
    .on('hold', function (event) {
      if(confirm("<?php echo e(__('Delete this table')); ?>")){
...
<?php echo $__env->make('layouts.app', ['title' => __($title)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurant\modules\Floorplan\Providers/../Resources/views/edit.blade.php ENDPATH**/ ?>