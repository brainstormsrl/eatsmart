<div id="c" class="mt-4">
    <div class="offcanvas-menu-inner">
        <div class="minicart-content">
                    ...
                    <ul class="list-group items" v-for="item in items">
                        ...
                        <li v-cloak class="list-group-item border-0 d-flex p-2 mb-2 bg-gray-100 border-radius-lg">
                            <div class="d-flex flex-column">
                              ...
                              <span class="mb-2 text-xs"><?php echo e(__('Price')); ?>: <span class="text-dark font-weight-bold ms-2">{{ item.attributes.friendly_price }}</span></span>
                              <span class="mb-2 text-xs"><?php echo e(__('QTY')); ?>: <span class="text-dark ms-2 font-weight-bold">{{ item.quantity }}</span></span>
                            </div>
                            <div class="ms-auto">
            ...
            <!-- Client Card -->
            <?php echo $__env->make('poscloud::pos.expedition', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- End client cart -->
            ...
            <div id="totalPrices" v-cloak>
                <div  class="card card-stats mb-4 mb-xl-0">
                    <div class="card-body">
                        ...
                        <div class="row" v-if="delivery">
                            <div class="col">
                                <span v-if="totalPrice"><strong><?php echo e(__('Delivery')); ?>:</strong></span>
                                <span v-if="totalPrice" class="ammount"><strong>{{ deliveryPriceFormated }}</strong></span>
                            </div>
                        </div>
                        <div class="row" v-if="deduct">
                            <div class="col">
                                <span v-if="deduct"><strong><?php echo e(__('Applied discount')); ?>:</strong></span>
                ...
                <div v-if="totalPrice" v-cloak>
                    <div v-if="totalPrice" v-cloak>
                        ...
                        <?php if(in_array("coupons", config('global.modules',[]))): ?>
                            ...
                            <div  class="card card-stats p-2 mb-0">
                                <div  class="row mt-3">
                                    ...
                                    <div class="col-md-5">
                                        <button onclick="applyDiscount()" id="promo_code_btn" type="button" class="btn btn-outline-primary w-100"><?php echo e(__('Apply')); ?></button>
                        ...
                        <button id='dineincheckout' type="button" class="btn btn-lg w-100 btn-primary text-white" data-bs-toggle="modal" data-bs-target="#modalPayment"><?php echo e(__('Checkout')); ?></button>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\restaurant\modules\Poscloud\Providers/../Resources/views/pos/cartSideMenu.blade.php ENDPATH**/ ?>