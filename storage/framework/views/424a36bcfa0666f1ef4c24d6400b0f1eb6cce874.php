<div style="display: none" class="container-fluid py-2" id="orders" >
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-12 my-auto text-end">
                <a href="#" onclick="createPickupOrder()" class="btn bg-gradient-primary active" role="button" aria-pressed="true">
                  ...
                  <span class="btn-inner--text d-none d-sm-inline-block"><?php echo e(__('New takeaway order')); ?></span>
                </a>
                <a href="#" onclick="createDeliveryOrder()" class="btn bg-gradient-primary active" role="button" aria-pressed="true">
                  ...
                  <span class="btn-inner--text d-none d-sm-inline-block"><?php echo e(__('New delivery order')); ?></span>
                </a>
                <a href="#" onclick="moveOrder()" class="btn bg-gradient-default active" role="button" aria-pressed="true">
                  ...
                  <span class="btn-inner--text d-none d-sm-inline-block"><?php echo e(__('Move order')); ?></span>
                </a>
              </div>
            </div>
          </div>
              ...
              <table class="table align-items-center mb-0" id="orderList">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2  d-none d-md-table-cell"><?php echo e(__('Recipt number')); ?></th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"><?php echo e(__('Order type')); ?></th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7   d-none d-md-table-cell "><?php echo e(__('Employee')); ?></th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7  d-none d-md-table-cell "><?php echo e(__('Total')); ?></th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"><?php echo e(__('Table/Client')); ?></th>
  ...
  </div><?php /**PATH C:\xampp\htdocs\restaurant\modules\Poscloud\Providers/../Resources/views/pos/orders.blade.php ENDPATH**/ ?>