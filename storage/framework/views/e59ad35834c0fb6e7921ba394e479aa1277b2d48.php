<?php $__env->startSection('tbody'); ?>
    <?php $__currentLoopData = $setup['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            ?>
             <?php if($setup['hasQR']): ?>
                <a href="<?php echo e(route('qr')."?table_id=".$item->id); ?>" target="_blank" class="btn btn-success btn-sm"><span class="btn-inner--icon"><i class="fas fa-qrcode"></i></span> <?php echo e(__('QR')); ?></a>
            <?php endif; ?>
...
<?php echo $__env->make('general.index', $setup, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurant\resources\views/tables/index.blade.php ENDPATH**/ ?>